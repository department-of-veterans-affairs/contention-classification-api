...
def test_health_check_success(test_client: TestClient, monkeypatch: MonkeyPatch) -> None:
    monkeypatch.setattr("src.api.dc_lookup_table", {"key1": "value:1"})
    monkeypatch.setattr("src.api.dropdown_lookup_table", {"key2": "value:2"})
    monkeypatch.setattr("src.api.expanded_lookup_table", {"key3": "value:3"})
    monkeypatch.setattr("src.api.ml_classifier", "not-none")
...
def test_health_check_empty_dc_lookup(test_client: TestClient, monkeypatch: MonkeyPatch) -> None:
    monkeypatch.setattr("src.api.dc_lookup_table", {})
    monkeypatch.setattr("src.api.ml_classifier", "not-none")
    response = test_client.get("/health")
...
def test_health_check_empty_expanded_lookup(test_client: TestClient, monkeypatch: MonkeyPatch) -> None:
    monkeypatch.setattr("src.api.dc_lookup_table", {})
    monkeypatch.setattr("src.api.dropdown_lookup_table", {})
    monkeypatch.setattr("src.api.expanded_lookup_table", {"key3": "value:3"})
    monkeypatch.setattr("src.api.ml_classifier", "not-none")
    response = test_client.get("/health")
    assert response.status_code == 500
...
def test_health_check_empty_contention_text_lookup(test_client: TestClient, monkeypatch: MonkeyPatch) -> None:
    monkeypatch.setattr("src.api.dc_lookup_table", {})
    monkeypatch.setattr("src.api.dropdown_lookup_table", {})
    monkeypatch.setattr("src.api.expanded_lookup_table", {})
    monkeypatch.setattr("src.api.ml_classifier", "not-none")
    response = test_client.get("/health")
    assert response.status_code == 500
...
def test_health_check_no_ml_classifier(test_client: TestClient, monkeypatch: MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("src.api.dropdown_lookup_table", {"key2": "value:2"})
    monkeypatch.setattr("src.api.expanded_lookup_table", {"key3": "value:3"})
    monkeypatch.setattr("src.api.ml_classifier", None)
    response = test_client.get("/health")
    assert response.status_code == 500
...
def test_health_check_empty_dc_lookup_and_no_ml_classifier(test_client: TestClient, monkeypatch: MonkeyPatch) -> None:
    ...
    response = test_client.get("/health")
    assert response.status_code == 500
    assert response.json() == {"detail": "DC Lookup table is empty, ML Classifier is not initialized"}
